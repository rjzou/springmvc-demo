						...
						<form role="form" method="post" action="#">
									...
									<table class="table table-bordered">
										...
										<tr>
											...
											<td><span class="label label-success">${params.in_date}</span>
												已经入住 <span class="label label-success">${params.in_days}</span>
												天</td>
										</tr>
							...
							<c:choose>
								<c:when test="${!empty params.return_url }">
									<a class="btn btn-warning" href="${params.return_url}"
										role="button">返回</a>
								</c:when>
								<c:otherwise>
									<a class="btn btn-warning" href="${ctx}/room_checkin_query"
										role="button">返回</a>
								</c:otherwise>
							</c:choose>
						</form>
