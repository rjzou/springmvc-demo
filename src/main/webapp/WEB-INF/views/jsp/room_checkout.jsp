				...
				<div class="widget-content">
					...
					<div class="widget-content">
						...
						<form class="form-inline" role="search"
							action="${ctx}/room_checkout" method="post">
							...
							<p class="text-left">
								<span class="label label-success">在住
									${params.full_room_count} 间</span> <span class="label label-info">今天退房
									${params.today_checkout_room_count} 间</span> <span
									class="label label-warning">今天入住
									${params.today_checkin_room_count} 间</span>
							</p>
						</form>
					</div>
					<!-- /.row -->
								...
								<c:forEach items="${list.content}" var="item" varStatus="status">
									<tr>
										...
										<td><a class="btn btn-danger btn-sm"
											href="${ctx}/room_tocheckout?houseid=${item.houseid }&roomno=${item.roomno }"
											role="button">退房</a> <a class="btn btn-info btn-sm"
											href="${ctx}/room_checkin_query_page?houseid=${item.houseid }&roomno=${item.roomno }&return_url=${ctx}/room_checkout"
											role="button">详情</a></td>
									</tr>
								</c:forEach>
							</tbody>
